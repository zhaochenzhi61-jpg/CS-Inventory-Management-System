...
public class BaiduUtil {
    ...
    public static String generalString(String imagePath, boolean isNewline){
        try{
            ...
            options.put("detect_direction", "true"); //SURE检测图像朝向，默认不检测，即：false
            options.put("detect_language", "true"); //SURE检测语言，默认不检测。
            options.put("probability", "false"); //SUREBack识别结果中每一行的置信度
            //通用文字识别
            if(ocrClient==null) {
