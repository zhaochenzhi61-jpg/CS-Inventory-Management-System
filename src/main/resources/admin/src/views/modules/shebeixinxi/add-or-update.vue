	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.shebeibianhao" label="E-Num" prop="shebeibianhao" >
					<el-input v-model="ruleForm.shebeibianhao" placeholder="E-Num" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="select" v-if="type!='info'"  label="E-Type" prop="shebeifenlei" >
					<el-select :disabled="ro.shebeifenlei" v-model="ruleForm.shebeifenlei" placeholder="Please selec Classification"  filterable>
						<el-option
							v-for="(item,index) in shebeifenleiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="E-Type" prop="shebeifenlei" >
					<el-input v-model="ruleForm.shebeifenlei"
						placeholder="E-Type" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="E-Model" prop="shebeixinghao" >
					<el-input v-model="ruleForm.shebeixinghao" placeholder="E-Model" clearable  :readonly="ro.shebeixinghao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="E-Model" prop="shebeixinghao" >
					<el-input v-model="ruleForm.shebeixinghao" placeholder="E-Model" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="E-Brand" prop="shebeipinpai" >
					<el-input v-model="ruleForm.shebeipinpai" placeholder="E-Brand" clearable  :readonly="ro.shebeipinpai"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="E-Brand" prop="shebeipinpai" >
					<el-input v-model="ruleForm.shebeipinpai" placeholder="E-Brand" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="E-Specifications" prop="shebeiguige" >
					<el-input v-model="ruleForm.shebeiguige" placeholder="E-Specifications" clearable  :readonly="ro.shebeiguige"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="E-Specifications" prop="shebeiguige" >
					<el-input v-model="ruleForm.shebeiguige" placeholder="E-Specifications" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="E-Total" prop="shebeizongshu" >
					<el-input v-model.number="ruleForm.shebeizongshu" placeholder="E-Total" clearable  :readonly="ro.shebeizongshu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="E-Total" prop="shebeizongshu" >
					<el-input v-model="ruleForm.shebeizongshu" placeholder="E-Total" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="Loan-Num" prop="jiechushuliang" >
					<el-input v-model.number="ruleForm.jiechushuliang" placeholder="Loan-Num" clearable  :readonly="ro.jiechushuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="Loan-Num" prop="jiechushuliang" >
					<el-input v-model="ruleForm.jiechushuliang" placeholder="Loan-Num" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="Available" prop="keyongshuliang" >
					<el-input v-model.number="ruleForm.keyongshuliang" placeholder="Available" clearable  :readonly="ro.keyongshuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="Available" prop="keyongshuliang" >
					<el-input v-model="ruleForm.keyongshuliang" placeholder="Available" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="Notes" prop="zhuyishixiang" >
					<el-input v-model="ruleForm.zhuyishixiang" placeholder="Notes" clearable  :readonly="ro.zhuyishixiang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="Notes" prop="zhuyishixiang" >
					<el-input v-model="ruleForm.zhuyishixiang" placeholder="Notes" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item v-if="type!='info'" class="editorBox" label="Equipment Details" prop="shebeixiangqing" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.shebeixiangqing" label="Equipment Details" prop="shebeixiangqing"  class="textBox">
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='shebeizongshu'){
							this.ruleForm.shebeizongshu = obj[o];
							this.ro.shebeizongshu = true;
							continue;
						}
						if(o=='jiechushuliang'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.shebeixiangqing = this.ruleForm.shebeixiangqing.replace(reg,'../../../inventoryx00baf6t/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
