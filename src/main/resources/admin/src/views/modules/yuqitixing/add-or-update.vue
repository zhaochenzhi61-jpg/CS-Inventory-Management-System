		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="Loan-Num" prop="jiechushuliang" >
					<el-input v-model="ruleForm.jiechushuliang" placeholder="Loan-Num" clearable  :readonly="ro.jiechushuliang"></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="Borrownumber" prop="keyongshuliang" >
					<el-input v-model="ruleForm.keyongshuliang" placeholder="Borrownumber" clearable  :readonly="ro.keyongshuliang"></el-input>
				</el-form-item>
				...
				<el-form-item class="date" v-if="type!='info'" label="Tiptime" prop="tixingshijian" >
					<el-date-picker
				...
				<el-form-item class="input" v-else-if="ruleForm.tixingshijian" label="Tiptime" prop="tixingshijian" >
					<el-input v-model="ruleForm.tixingshijian" placeholder="Tiptime" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item v-if="type!='info'" class="editorBox" label="Overdue Reminder" prop="yuqitixing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.yuqitixing" 
					class="editor"
					myQuillEditor="yuqitixing"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.yuqitixing" label="Overdue Reminder" prop="yuqitixing"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.yuqitixing"></span>
			</el-form-item>
...
<script>
	export default {
		...
		created() {
			this.ruleForm.tixingshijian = this.getCurDate()
		},
		methods: {
			// 下载
			download(file){
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='yuqitixing'){
							this.ruleForm.yuqitixing = obj[o];
							this.ro.yuqitixing = true;
							continue;
						}
						if(o=='crossuserid'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.yuqitixing = this.ruleForm.yuqitixing.replace(reg,'../../../inventoryx00baf6t/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
