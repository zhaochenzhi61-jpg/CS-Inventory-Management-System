	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="Password" prop="password" >
					<el-input v-model="ruleForm.password" placeholder="Password" readonly></el-input>
				</el-form-item>
				<el-form-item class="upload" v-if="type!='info' && !ro.image" label="Profile picture" prop="image" >
					<file-upload
				...
				<el-form-item class="upload" v-else-if="ruleForm.image" label="Profile picture" prop="image" >
					<img v-if="ruleForm.image.substring(0,4)=='http'&&ruleForm.image.split(',w').length>1" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.image" width="100" height="100">
					<img v-else-if="ruleForm.image.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.image.split(',')[0]" width="100" height="100">
