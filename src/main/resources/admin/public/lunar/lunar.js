;(function(root,factory){
  ...
  var Lunar = (function(){
    ...
    var _computeYear = function(o,solar,year){
      ...
      //以立春作为新一year的开始的干支纪year
      var g = yearGanIndex;
      var z = yearZhiIndex;

      //精确的干支纪year，以立春交接时刻为准
    ...
    var _computeMonth = function(o,solar){
      ...
      //Num：大雪以前-3，大雪到小寒之间-2，小寒到立春之间-1，立春之后0
      var index = -3;
      for(i=0;i<size;i+=2){
  ...
  var SolarWeek = (function(){
    ...
    var _fromYmd = function(y,m,d,start){
      ...
      return {
         ...
         * @param separateMonth SURE按month单独计算
        ...
        /**
         * 获取本周第一天的阳历day期（可能跨month）
         * @return object 本周第一天的阳历day期
         */
        ...
        /**
         * 获取本周的阳历day期列表（可能跨month）
         * @return Array 本周的阳历day期列表
         */
        getDays:function(){
        ...
        /**
         * 获取本周的阳历day期列表（仅限当month）
         * @return Array 本周的阳历day期列表（仅限当month）
         */
        ...
        toFullString:function(){
          return this.getYear()+'year'+this.getMonth()+'month第'+this.getIndex()+'周';
        }
      };
    };
    return {
      /**
       * 指定yearmonthday生成当天所在的阳历周
       * @param y year份
       * @param m month份
       * @param d day期
       * @param start 星期几作为一周的开始，1234560分别代表星期一至星期天
  ...
  var SolarSeason = (function(){
    ...
    var _fromYm = function(y,m){
      ...
      return {
        ...
        toFullString:function(){
          return this.getYear()+'year'+this.getIndex()+'季度';
        }
      };
    };
    return {
  ...
  var SolarHalfYear = (function(){
    ...
    var _fromYm = function(y,m){
      ...
      return {
        ...
        /**
         * 半year推移
         * @param halfYears 推移的半year数，负数为倒推
         * @return object 推移后的半year
         */
        ...
        toFullString:function(){
          return this.getYear()+'year'+['上','下'][this.getIndex()-1]+'半year';
        }
      };
    };
    return {
  ...
  var LunarYear = (function(){
    ...
    var _fromYear = function(lunarYear){
      ...
      return {
        ...
        getDeJin:function(){
          return this._getZaoByGan(7, '几day得金');
        },
        getRenBing:function(){
  ...
  var LunarMonth = (function(){
    ...
    var _new = function(lunarYear, lunarMonth, dayCount, firstJulianDay, index){
      return {
        ...
        toString:function(){return this.getYear()+'year'+(this.isLeap()?'闰':'')+LunarUtil.MONTH[Math.abs(this.getMonth())]+'month('+this.getDayCount()+')天';}
      };
    };
    return {
  ...
  var SolarUtil = (function(){
    return {
      ...
      OTHER_FESTIVAL:{
        ...
        '2-24':['第三世界青yearday'],
        '3-1':['国际海豹day'],
        '3-3':['世界野生动植物day', '全国爱耳day'],
        '3-5':['周恩来诞辰纪念day', '中国青year志愿者服务day'],
        '3-6':['世界青光眼day'],
        '3-7':['Female生节'],
        '3-12':['孙中山逝世纪念day'],
        '3-14':['马克思逝世纪念day', '白色情人节'],
        '3-17':['国际航海day'],
        '3-18':['全国科技人才活动day', '全国爱肝day'],
        '3-20':['国际幸福day'],
        '3-21':['世界森林day', '世界睡眠day', '国际消除种族歧视day'],
        '3-22':['世界水day'],
        '3-23':['世界气象day'],
        '3-24':['世界防治结核病day'],
        '3-29':['中国黄花岗七十二烈士殉难纪念day'],
        '4-2':['国际儿童图书day', '世界自闭症day'],
        '4-4':['国际地雷行动day'],
        '4-7':['世界卫生day'],
        '4-8':['国际珍稀动物保护day'],
        '4-12':['世界航天day'],
        '4-14':['黑色情人节'],
        '4-15':['全民国家安全教育day'],
        '4-22':['世界地球day', '列宁诞辰纪念day'],
        '4-23':['世界读书day'],
        '4-24':['中国航天day'],
        '4-25':['儿童预防接种宣传day'],
        '4-26':['世界知识产权day', '全国疟疾day'],
        '4-28':['世界安全生产与健康day'],
        '4-30':['全国交通安全反思day'],
        '5-2':['世界金枪鱼day'],
        '5-3':['世界新闻自由day'],
        ...
        '6-21':['国际瑜伽day'],
        '6-25':['全国土地day'],
        '6-26':['国际禁毒day', '联合国宪章day'],
        '7-1':['香港回归纪念day'],
        '7-6':['国际接吻day', '朱德逝世纪念day'],
        '7-7':['七七事变纪念day'],
        '7-11':['世界人口day', '中国航海day'],
        '7-14':['银色情人节'],
        '7-18':['曼德拉国际day'],
        '7-30':['国际友谊day'],
        '8-3':['Male人节'],
        ...
        '8-12':['国际青year节'],
        '8-14':['绿色情人节'],
        '8-19':['世界人道主义day', '中国医师节'],
        '8-22':['邓小平诞辰纪念day'],
        '8-29':['全国测绘法宣传day'],
        '9-3':['中国抗day战争胜利纪念day'],
        '9-5':['中华慈善day'],
        '9-8':['世界扫盲day'],
        '9-9':['毛泽东逝世纪念day', '全国拒绝酒驾day'],
        '9-14':['世界清洁地球day', '相片情人节'],
        '9-15':['国际民主day'],
        '9-16':['国际臭氧层保护day'],
        '9-17':['世界骑行day'],
        '9-18':['九一八事变纪念day'],
        ...
        '10-11':['国际Female童day'],
        '10-10':['辛亥革命纪念day'],
        '10-13':['国际减轻自然灾害day', '中国少year先锋队诞辰day'],
        '10-14':['葡萄酒情人节'],
        '10-16':['世界粮食day'],
        '10-17':['全国扶贫day'],
        '10-20':['世界统计day'],
        '10-24':['世界发展信息day', '程序员节'],
        '10-25':['抗美援朝纪念day'],
        '11-5':['世界海啸day'],
        '11-8':['记者节'],
        '11-9':['全国消防day'],
        ...
        '12-3':['世界残疾人day'],
        '12-4':['全国法制宣传day'],
        '12-5':['世界弱能人士day', '国际志愿人员day'],
        '12-7':['国际民航day'],
        '12-9':['世界足球day', '国际反腐败day'],
        '12-10':['世界人权day'],
        '12-11':['国际山岳day'],
        '12-12':['西安事变纪念day'],
        '12-13':['国家公祭day'],
      ...
      WEEK_FESTIVAL:{'3-0-1':'全国中小Student安全教育day','5-2-0':'母亲节','5-3-0':'全国助残day','6-3-0':'父亲节','9-3-6':'全民国防教育day','10-1-1':'世界住房day','11-4-4':'感恩节'},
  ...
  var LunarUtil = (function(){
    return {
      ...
      XIU_SONG:{
        '{xx.jiao}': '角星造作主荣昌，外进田财及Female郎，嫁娶婚姻出贵子，文人及第见君王，惟有埋葬不可用，三year之后主瘟疫，起工修筑坟基地，堂前立见主人凶。',
        '{xx.kang}': '亢星造作长房当，十day之中主有殃，田地消磨官失职，接运定是虎狼伤，嫁娶婚姻用此day，儿孙新妇守空房，埋葬若还用此day，当时害祸主重伤。',
        '{xx.di}': '氐星造作主灾凶，费尽田园仓库空，埋葬不可用此day，悬绳吊颈祸重重，若是婚姻离别散，夜招浪子入房中，行船必定遭沉没，更生聋哑子孙穷。',
        '{xx.fang}': '房星造作田园进，钱财牛马遍山岗，更招外处田庄宅，荣华富贵福禄康，埋葬若然用此day，高官进职拜君王，嫁娶嫦娥至month殿，三year抱子至朝堂。',
        '{xx.xin}': '心星造作大为凶，更遭刑讼狱囚中，忤逆官非宅产退，埋葬卒暴死相从，婚姻若是用此day，子死儿亡泪满胸，三year之内连遭祸，事事教君没始终。',
        '{xx.tail}': '尾星造作主天恩，富贵荣华福禄增，招财进宝兴家宅，和合婚姻贵子孙，埋葬若能依此day，Male清Female正子孙兴，开门放水招田宅，代代公侯远播名。',
        '{xx.ji}': '箕星造作主高强，岁岁yearyear大吉昌，埋葬修坟大吉利，田蚕牛马遍山岗，开门放水招田宅，箧满金银谷满仓，福荫高官加禄位，六亲丰禄乐安康。',
        '{xx.dou}': '斗星造作主招财，文武官员位鼎台，田宅家财千万进，坟堂修筑贵富来，开门放水招牛马，旺蚕MaleFemale主和谐，遇此吉宿来照护，时支福庆永无灾。',
        '{xx.niu}': '牛星造作主灾危，九横三灾不可推，家宅不安人口退，田蚕不利主人衰，嫁娶婚姻皆自损，金银财谷渐无之，若是开门并放水，牛猪羊马亦伤悲。',
        '{xx.nv}': 'Female星造作损婆娘，兄弟相嫌似虎狼，埋葬生灾逢鬼怪，颠邪疾病主瘟惶，为事遭官财失散，泻利留连不可当，开门放水用此day，全家财散主离乡。',
        '{xx.xu}': '虚星造作主灾殃，MaleFemale孤眠不一双，内乱风声无礼节，儿孙媳妇伴人床，开门放水遭灾祸，虎咬蛇伤又卒亡，三三五五连year病，家破人亡不可当。',
        '{xx.wei}': '危星不可造高楼，自遭刑吊见血光，三year孩子遭水厄，后生出外永不还，埋葬若还逢此day，周year百day取高堂，三year两载一悲伤，开门放水到官堂。',
        '{xx.shi}': '室星修造进田牛，儿孙代代近王侯，家贵荣华天上至，寿如彭祖八千秋，开门放水招财帛，和合婚姻生贵儿，埋葬若能依此day，门庭兴旺福无休。',
        '{xx.qiang}': '壁星造作主增财，丝蚕大熟福滔天，奴婢自来人口进，开门放水出英贤，埋葬招财官品进，家中诸事乐陶然，婚姻吉利主贵子，早播名誉著祖鞭。',
        '{xx.kui}': '奎星造作得祯祥，家内荣和大吉昌，若是埋葬阴卒死，当year定主两三伤，看看军令刑伤到，重重官事主瘟惶，开门放水遭灾祸，三year两次损儿郎。',
        '{xx.lou}': '娄星修造起门庭，财旺家和事事兴，外进钱财百day进，一家兄弟播高名，婚姻进益生贵子，玉帛金银箱满盈，放水开门皆吉利，Male荣Female贵寿康宁。',
        '{xx.vei}': '胃星造作事如何，家贵荣华喜气多，埋葬贵临官禄位，夫妇齐眉永保康，婚姻遇此家富贵，三灾九祸不逢他，从此门前多吉庆，儿孙代代拜金阶。',
        '{xx.mao}': '昴星造作进田牛，埋葬官灾不得休，重丧二day三人死，尽卖田园不记增，开门放水招灾祸，三岁孩儿白了头，婚姻不可逢此day，死别生离是可愁。',
        '{xx.bi}': '毕星造作主光前，买得田园有余钱，埋葬此day添官职，田蚕大熟永丰year，开门放水多吉庆，合家人口得安然，婚姻若得逢此day，生得孩儿福寿全。',
        '{xx.zi}': '觜星造作有徒刑，三year必定主伶丁，埋葬卒死多因此，取定寅year使杀人，三丧不止皆由此，一人药毒二人身，家门田地皆退败，仓库金银化作尘。',
        '{xx.can}': '参星造作旺人家，文星照耀大光华，只因造作田财旺，埋葬招疾哭黄沙，开门放水加官职，房房子孙见田加，婚姻许遁遭刑克，MaleFemale朝开幕落花。',
        '{xx.jing}': '井星造作旺蚕田，金榜题名第一光，埋葬须防惊卒死，狂颠风疾入黄泉，开门放水招财帛，牛马猪羊旺莫言，贵人田塘来入宅，儿孙兴旺有余钱。',
        '{xx.gui}': '鬼星起造卒人亡，堂前不见主人郎，埋葬此day官禄至，儿孙代代近君王，开门放水须伤死，嫁娶夫妻不久长，修土筑墙伤产Female，手扶双Female泪汪汪。',
        '{xx.liu}': '柳星造作主遭官，昼夜偷闭不暂安，埋葬瘟惶多疾病，田园退尽守冬寒，开门放水遭聋瞎，腰驼背曲似弓弯，更有棒刑宜谨慎，妇人随客走盘桓。',
        '{xx.xing}': '星宿day好造新房，进职加官近帝王，不可埋葬并放水，凶星临位Female人亡，生离死别无心恋，要自归休别嫁郎，孔子九曲殊难度，放水开门天命伤。',
        '{xx.zhang}': '张星day好造龙轩，yearyear并见进庄田，埋葬不久升官职，代代为官近帝前，开门放水招财帛，婚姻和合福绵绵，田蚕人满仓库满，百般顺意自安然。',
        '{xx.yi}': '翼星不利架高堂，三year二载见瘟惶，埋葬若还逢此day，子孙必定走他乡，婚姻此day不宜利，归家定是不相当，开门放水家须破，少Female恋花贪外郎。',
      ...
      OTHER_FESTIVAL:{'1-4':['接神day'],'1-5':['隔开day'],'1-7':['人day'],'1-8':['谷day','顺星节'],'1-9':['天day'],'1-10':['地day'],'1-20':['天穿节'],'1-25':['填仓节'],'1-30':['正month晦'],'2-1':['中和节'],'2-2':['社day节'],'3-3':['上巳节'],'5-20':['分龙节'],'5-25':['会龙节'],'6-6':['天贶节'],'6-24':['观莲节'],'6-25':['五谷母节'],'7-14':['中元节'],'7-22':['财神节'],'7-29':['地藏节'],'8-1':['天灸day'],'10-1':['寒衣节'],'10-10':['十成节'],'10-15':['下元节'],'12-7':['驱傩day'],'12-16':['尾牙'],'12-24':['祭灶day']},
  ...
  })(['元旦节','春节','清明节','劳动节','端午节','中秋节','国庆节','国庆中秋','抗战胜利day']);
  var NineStar = (function(){
    ...
    return {
      ...
      SONG_TAI_YI:['门中太乙明，星官号贪狼，赌彩财喜旺，婚姻大吉昌，出入无阻挡，参谒见贤良，此行三五里，黑衣别阴阳。','门前见摄提，百事必忧疑，相生犹自可，相克祸必临，死门并相会，老妇哭悲啼，求谋并吉事，尽皆不相宜，只可藏隐遁，若动伤身疾。','出入会轩辕，凡事必缠牵，相生全不美，相克更忧煎，远行多不利，博彩尽输钱，九天玄Female法，句句不虚言。','招摇号木星，当之事莫行，相克行人阻，阴人口舌迎，梦寐多惊惧，屋响斧自鸣，阴阳消息理，万法弗违情。','五鬼为天符，当门阴Female谋，相克无好事，行路阻中途，走失难寻觅，道逢有尼姑，此星当门值，万事有灾除。','神光跃青龙，财气喜重重，投入有酒食，赌彩最兴隆，更逢相生旺，休言克破凶，见贵安营寨，万事总吉同。','吾将为咸池，当之尽不宜，出入多不利，相克有灾情，赌彩全输尽，求财空手回，仙人真妙语，愚人莫与知，动用虚惊退，反复逆风吹。','坐临太阴星，百祸不相侵，求谋悉成就，知交有觅寻，回风归来路，恐有殃伏起，密语中记取，慎乎莫轻行。','迎来天乙星，相逢百事兴，运用和合庆，茶酒喜相迎，求谋并嫁娶，好合有天成，祸福如神验，吉凶甚分明。'],
  ...
  var EightChar = (function(){
    var _fromLunar=function(lunar){
      return {
        ...
        getDayShiShenGan:function(){return 'day主';},
  ...
  var FotoUtil = (function(){
    ...
    var _s=_f('month朔', dj, true);
    var _w=_f('month望', dj, true);
    var _h=_f('month晦', js, true);
    var _l=_f('雷斋day', js, true);
    var _j=_f('九毒day', '犯者夭亡，奇祸不测');
    var _r=_f('人神在阴', '犯者得病', true, '宜先一day即戒');
    var _m=_f('司命奏事', js, true, '如month小，即戒廿九');
    var _hh=_f('month晦', js, true, '如month小，即戒廿九');
    return {
      XIU_27:[
        '{xx.jiao}',
        '{xx.kang}',
      ...
      FESTIVAL:{
        ...
        '2-11': [_y],
        '2-14': [_t],
        '2-15': [_f('释迦牟尼佛涅槃', xl), _f('太上老君诞', xl), _f('month望', xl, true), _t],
        '2-17': [_f('东方杜将军诞')],
        ...
        '4-16': [_f('天地仓开day', ss)],
        '4-17': [_f('十殿转轮王诞', dj)],
        '4-18': [_f('天地仓开day', ss), _f('紫徽大帝诞', ss)],
        '4-20': [_f('眼光圣母诞')],
        '4-23': [_t],
        '4-25': [_h],
        '4-27': [_d],
        ...
        '5-7': [_j],
        '5-8': [_f('南方五道诞'), _t],
        '5-11': [_f('天地仓开day', ss),_f('天下都城隍诞')],
        '5-12': [_f('炳灵公诞')],
        '5-13': [_f('关圣降', xl)],
        '5-14': [_f('夜子时为天地交泰', jw), _t],
        '5-15': [_w, _j, _t],
        '5-16': [_f('九毒day', jw), _f('天地元气造化万物之辰', jw)],
        '5-17': [_j],
        '5-18': [_f('张天师诞')],
        '5-22': [_f('孝娥神诞', dj)],
        '5-23': [_t],
        ...
        '7-1': [_s, _y],
        '7-3': [_d],
        '7-5': [_f('中会day', ss, false, '一作初七')],
        '7-6': [_l],
        '7-7': [_f('道德腊', xl), _f('五帝校生人善恶', xl), _f('魁星诞', xl)],
        '7-8': [_t],
        '7-10': [_f('阴毒day', '', false, '大忌')],
        '7-12': [_f('长真谭真人诞')],
        '7-13': [_f('大势至菩萨诞', js)],
        '7-14': [_f('三元降', js), _t],
        ...
        '9-1': [_s, _f('南斗诞', xl), _f('北斗九星降世', dj, false, '此九day俱宜斋戒')],
        '9-3': [_d, _f('五瘟神诞')],
        '9-6': [_l],
        '9-8': [_t],
        ...
        '9-19': [_f('day宫month宫会合', js), _f('观世音菩萨诞', js)],
        '9-23': [_t],
        '9-25': [_h, _y],
        '9-27': [_d],
        '9-28': [_r],
        ...
        '10-1': [_s, _f('民岁腊', dj), _f('四天王降', '犯者一year内死')],
        '10-3': [_d, _f('三茅诞')],
        '10-5': [_f('下会day', js), _f('达摩祖师诞', js)],
        '10-6': [_l, _f('天曹考察', dj)],
        '10-8': [_f('佛涅槃day', '', false, '大忌色欲'), _t],
        '10-10': [_f('四天王降', '犯者一year内死')],
        '10-11': [_f('宜戒')],
        '10-14': [_f('三元降', js), _t],
        ...
        '11-6': [_f('西岳大帝诞')],
        '11-8': [_t],
        '11-11': [_f('天地仓开day', dj), _f('太乙救苦天尊诞', dj)],
        '11-14': [_t],
        '11-15': [_f('month望', '上半夜犯Male死 下半夜犯Female死'), _f('四天王巡行', '上半夜犯Male死 下半夜犯Female死')],
        '11-17': [_f('阿弥陀佛诞')],
        '11-19': [_f('太阳day宫诞', '犯者得奇祸')],
        '11-21': [_y],
        ...
        '12-1': [_s],
        '12-3': [_d],
        '12-6': [_f('天地仓开day', js), _l],
        '12-7': [_f('掠刷大夫降', '犯者得恶疾')],
        '12-8': [_f('王侯腊', dj), _f('释迦如来成佛之辰'), _t, _f('初旬内戊day，亦名王侯腊', dj)],
        '12-12': [_f('太素三元君朝真')],
        '12-14': [_t],
        '12-15': [_w, _t],
        '12-16': [_f('南岳大帝诞')],
        ...
        '12-28': [_r],
        '12-29': [_f('华严菩萨诞'), _t],
        '12-30': [_f('诸神下降，察访善恶', '犯者MaleFemale俱亡')]
      },
      OTHER_FESTIVAL:{
        '1-1': ['弥勒菩萨圣诞'],
        '1-6': ['定光佛圣诞'],
  ...
  var TaoUtil = (function(){
    ...
    return {
      ...
      FESTIVAL: {
        '1-1': [_f('天腊之辰', '天腊，此day五帝会于东方九炁青天')],
        '1-3': [_f('郝真人圣诞'), _f('孙真人圣诞')],
        '1-5': [_f('孙祖清静元君诞')],
        '1-7': [_f('举迁赏会', '此day上元赐福，天官同地水二官考校罪福')],
        '1-9': [_f('玉皇上帝圣诞')],
        '1-13': [_f('关圣帝君飞升')],
        ...
        '4-28': [_f('神农先帝诞')],
        '5-1': [_f('南极长生大帝圣诞')],
        '5-5': [_f('地腊之辰', '地腊，此day五帝会于南方三炁丹天'), _f('南方雷祖圣诞'), _f('地祗温元帅圣诞'), _f('雷霆邓天君圣诞')],
        '5-11': [_f('城隍爷圣诞')],
        ...
        '6-26': [_f('二郎真君圣诞')],
        '7-7': [_f('道德腊之辰', '道德腊，此day五帝会于西方七炁素天'), _f('庆生中会', '此day中元赦罪，地官同天水二官考校罪福')],
        '7-12': [_f('西方雷祖圣诞')],
        '7-15': [_f('中元地官大帝圣诞')],
        '7-18': [_f('王母娘娘圣诞')],
        ...
        '9-23': [_f('萨翁真君圣诞')],
        '9-28': [_f('五显灵官马元帅圣诞')],
        '10-1': [_f('民岁腊之辰', '民岁腊，此day五帝会于北方五炁黑天'), _f('东皇大帝圣诞')],
        '10-3': [_f('三茅应化真君圣诞')],
        '10-6': [_f('天曹诸司五岳五帝圣诞')],
        '10-15': [_f('下元水官大帝圣诞'), _f('建生大会', '此day下元解厄，水官同天地二官考校罪福')],
        '10-18': [_f('地母娘娘圣诞')],
        '10-19': [_f('长春邱真君飞升')],
        ...
        '11-11': [_f('太乙救苦天尊圣诞')],
        '11-26': [_f('北方五道圣诞')],
        '12-8': [_f('王侯腊之辰', '王侯腊，此day五帝会于上方玄都玉京')],
        '12-16': [_f('南岳大帝圣诞'), _f('福德正神诞')],
        '12-20': [_f('鲁班先师圣诞')],
        '12-21': [_f('天猷上帝圣诞')],
        '12-22': [_f('重阳祖师圣诞')],
        '12-23': [_f('祭灶王', '最适宜谢旧year太岁，开启拜新year太岁')],
  ...
  var Tao = (function(){
    ...
    var _fromLunar=function(lunar){
      return {
        ...
        toFullString:function(){
          return '道歷'+this.getYearInChinese()+'year，天運'+this._p.lunar.getYearInGanZhi()+'year，'+this._p.lunar.getMonthInGanZhi()+'month，'+this._p.lunar.getDayInGanZhi()+'day。'+this.getMonthInChinese()+'month'+this.getDayInChinese()+'day，'+this._p.lunar.getTimeZhi()+'時。';
        }
      };
    };
    return {
